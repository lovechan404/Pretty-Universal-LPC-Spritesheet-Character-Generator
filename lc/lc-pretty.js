...
// Add this to lc-pretty.js

// Store original generator functions
let originalGenerateSpritesheet = null;
let originalDownloadSheet = null;

document.addEventListener('DOMContentLoaded', function() {
  // Override after page loads
  overrideSpritesheetGeneration();
});

function overrideSpritesheetGeneration() {
  // Store original functions
  originalGenerateSpritesheet = generateSpritesheet;
  originalDownloadSheet = downloadSheet;

  // Override generation
  generateSpritesheet = function() {
    originalGenerateSpritesheet();
    updateSpritesheetCrop();
  };
  ...
  document.getElementById('whichAnim').addEventListener('change', function() {
    updateSpritesheetCrop();
  });
}
...
function createCroppedCanvas(sourceCanvas) {
  ...
  const cropHeight = 64; // Single row height
